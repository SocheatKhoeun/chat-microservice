...
import { ConnectedSocket, MessageBody, OnGatewayConnection, OnGatewayDisconnect, 
  OnGatewayInit, SubscribeMessage, WebSocketGateway, WebSocketServer } from '@nestjs/websockets';
import type { Server, Socket } from 'socket.io';
import type { users } from '../../../generated/prisma/client';
import { DtoValidationError, validateDto } from '../../common/utils/validate-dto.util';
...
import { JoinConversationDto, ListMessagesWsDto, MarkReadDto, TypingDto, WsSendMessageDto } from './chat.model';
...
function conversationRoom(conversationHash: string): string {
  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  private async broadcastPresence(
    ...
    this.server.to(contactIds.map(userRoom)).emit(event, { user_id: userId });
  }
